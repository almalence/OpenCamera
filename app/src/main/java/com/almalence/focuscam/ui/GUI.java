...
public abstract class GUI
{
	...
	protected boolean 		appIsPortrait					= true;
	...
	static protected int 	mAdditionalLayoutOrientation = 90; //PORTRAIT mode, LANDSCAPE will be 0
...
//		mAdditionalLayoutOrientation = 0;
	...
	{
		return (mDeviceOrientation + (appIsPortrait ? 90 : 0)/*mAdditionalLayoutOrientation*/) % 360;
	...
	public int getImageDataOrientation()
	{
		...
		int imageOrientation = (mDeviceOrientation  - (appIsPortrait ? 0 : 90) + (sensorOrientation + (CameraController.isFrontCamera()? 180 : 0))%360) % 360;
