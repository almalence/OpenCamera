...
/* <!-- +++
 package com.almalence.focuscam_plus.ui;
 +++ --> */
// <!-- -+-
package com.almalence.focuscam.ui;
...
/* <!-- +++
 ...
 import com.almalence.focuscam_plus.Mode;
 import com.almalence.focuscam_plus.Plugin;
 import com.almalence.focuscam_plus.PluginManager;
 import com.almalence.focuscam_plus.PluginType;
 import com.almalence.focuscam_plus.Preferences;
...
{
    private static final String TAG = "AlmalenceGUI";
...
//        Log.e(TAG, "onStart");
        ...
        if(appIsPortrait)
            ...
            mAdditionalLayoutOrientation = 90;
		...
		// -+- -->
		RotateImageView rotate = ((RotateImageView) guiView.findViewById(R.id.Rotate));
		...
		rotate.setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
                ...
                {
                    mAdditionalLayoutOrientation = 90;
                    ApplicationScreen.instance.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
                }
                else
                {
                    mAdditionalLayoutOrientation = 0;
                    ApplicationScreen.instance.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
                }
	...
	private void initOrientationListener()
	{
		...
		this.orientListener = new OrientationEventListener(ApplicationScreen.getMainContext())
		{
			...
			{				
                ...
                orientation = (orientation + mAdditionalLayoutOrientation)%360;
                ...
                ((RotateImageView) guiView.findViewById(R.id.Rotate))
                        .setOrientation(AlmalenceGUI.mDeviceOrientation);
...
//						+ previewSize.getHeight());
		...
		} else
		{
            ...
            else
            {
                ...
                if (Math.abs(surfaceAspect - cameraAspect) > 0.05d)
                {
                    if (cameraAspect > surfaceAspect && (Math.abs(1 - surfaceAspect) > 0.05d)) {
                        int paramsLayoutHeight = (int) MainScreen.getAppResources()
                                .getDimension(R.dimen.paramsLayoutHeight);
                        // if wide-screen - decrease width of surface
...
//						int nWidth = (int) (screen_width - 2 * paramsLayoutHeight);
//						int nWidth = (int)(previewSurfaceHeight * 1.777777778d);
//						int nWidth = (int)(previewSurfaceHeight * 1.1111111d);
//						int nWidth = (int)(previewSurfaceWidth * cameraAspect);
						int nWidth = (int)(previewSurfaceWidth / cameraAspect);
                        lp.width = nWidth;
//						lp.height = nWidth;
						lp.leftMargin = (int) (screen_width - nWidth)/2;
//						lp.leftMargin = (int) (screen_width - previewSurfaceHeight)/2;

                    } else if (cameraAspect > surfaceAspect) {
                        int paramsLayoutHeight = (int) MainScreen.getAppResources()
                                .getDimension(R.dimen.paramsLayoutHeight);
                        // if wide-screen - decrease width of surface
                        lp.width = previewSurfaceHeight;
                        ...
                        lp.height = previewSurfaceHeight;
                        lp.leftMargin = (int) (paramsLayoutHeight);
                    }
                }
            }
		}
...
//		ApplicationScreen.getPreviewSurfaceView().setLayoutParams(lp);
		if(!appIsPortrait)
			ApplicationScreen.getPreviewTextureView().setLayoutParams(lp);
//		ApplicationScreen.setPreviewTextureViewSize(lp.width, lp.height);
...
//					ApplicationScreen.instance.setFocusModePref(mFocusMode);
	...
	public boolean onTouch(View view, MotionEvent event)
	{
		...
		if (view == /*ApplicationScreen.getPreviewSurfaceView()*/ApplicationScreen.getPreviewTextureView())
		{
