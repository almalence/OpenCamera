...
/* <!-- +++
 ...
 import com.almalence.focuscam_plus.ui.GLLayer;
 import com.almalence.focuscam_plus.ui.GUI;
 import com.almalence.focuscam_plus.R;
 +++ --> */
//<!-- -+-
import com.almalence.focuscam.cameracontroller.CameraController;
import com.almalence.focuscam.ui.AutoFitTextureView;
import com.almalence.focuscam.ui.GLLayer;
import com.almalence.focuscam.ui.GUI;
...
abstract public class ApplicationScreen extends Activity implements ApplicationInterface, View.OnClickListener,
		View.OnTouchListener, /*SurfaceHolder.Callback,*/ Handler.Callback, Camera.ShutterCallback, TextureView.SurfaceTextureListener {
	// >>Description
	...
	protected AutoFitTextureView mTextureView; //TODO: use instead SurfaceView
	protected SurfaceTexture	 mTexture;
	/**
	 * The {@link Size} of camera preview.
	 */
	private Size mPreviewSize; //TODO: Use for TextureView case only
...
//		mTextureView.setOnClickListener(ApplicationScreen.this);
//		mTextureView.setOnTouchListener(ApplicationScreen.this);
...
//	}
	public static TextureView getPreviewTextureView()
		{
			return instance.mTextureView;
		}

	@TargetApi(15)
	public static void setPreviewTextureViewSize(int width, int height)
	{
		instance.mTexture.setDefaultBufferSize(width, height);
	}
	...
	public static boolean setSurfaceHolderSize(int viewWidth, int viewHeight) {

		ApplicationScreen.instance.mTexture = ApplicationScreen.instance.mTextureView.getSurfaceTexture();
		assert ApplicationScreen.instance.mTexture != null;

		// We configure the size of default buffer to be the size of camera preview we want.
		ApplicationScreen.instance.mTexture.setDefaultBufferSize(viewWidth, viewHeight);

		ApplicationScreen.instance.mCameraSurface = new Surface(ApplicationScreen.instance.mTexture);

//		if ((instance.surfaceWidth != width && instance.surfaceHeight != height) || CameraController.isSnapdgragonTestDevice)
//		{
...
////				ApplicationScreen.instance.preview.setRotation(180);
...
//		messageHandler.sendEmptyMessage(ApplicationInterface.MSG_SURFACE_READY);
	...
	public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
		configureTransform(this.surfaceLayoutWidth, this.surfaceLayoutHeight);
	}
...
//		mCamera.release();
	...
	private void setUpCameraOutputs(int width, int height) {
		CameraManager manager = (CameraManager) instance.getSystemService(Context.CAMERA_SERVICE);
		try {
			for (String cameraId : manager.getCameraIdList()) {
				...
				// coordinate.
				int displayRotation = instance.getWindowManager().getDefaultDisplay().getRotation();
...
//						Log.e(TAG, "Display rotation is invalid: " + displayRotation);
				...
				instance.getWindowManager().getDefaultDisplay().getSize(displaySize);
	...
	private void configureTransform(int viewWidth, int viewHeight)
	{
		...
		RectF bufferRect = new RectF(0, 0, previewHeight, previewWidth); //ORIGINAL CODE
		...
		else if(Surface.ROTATION_0 == rotation && appIsPortrait)
		{
//			mTextureView.setAspectRatio(previewWidth, previewHeight);
//			viewRect = new RectF(0, 0, viewHeight, viewWidth);
//			bufferRect = new RectF(0, 0, previewWidth, previewHeight);
//			bufferRect.offset(centerX - bufferRect.centerX(), centerY - bufferRect.centerY());
			bufferRect.offset(centerX - bufferRect.centerX(), centerY - bufferRect.centerY());
//			matrix.setRectToRect(viewRect, bufferRect, Matrix.ScaleToFit.FILL);
			float scale = Math.max(
...
//			Log.e(TAG, "Couldn't find any suitable preview size");
	...
	public Action getIndexApiAction() {
		Thing object = new Thing.Builder()
				.setName("ApplicationScreen Page") // TODO: Define a title for the content shown.
...
//		}
		...
		return new CameraController.Size(0, 0);
	}
