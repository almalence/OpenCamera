...
//				mFocusArea.get(0).rect);
		CameraController.calculateTapArea(focusWidth, focusHeight, 1f, top, left,
				ApplicationScreen.getPreviewTextureView().getWidth(), ApplicationScreen.getPreviewTextureView().getHeight(),
				xRaw, yRaw, mMatrix,
				mFocusArea.get(0).rect);
...
//					mMeteringArea.get(0).rect);
			CameraController.calculateTapArea(focusWidth, focusHeight, 1f, top, left,
					ApplicationScreen.getPreviewTextureView()
							.getWidth(), ApplicationScreen.getPreviewTextureView().getHeight(),
					xRaw, yRaw, mMatrix,
					mMeteringArea.get(0).rect);
		else
			mMeteringArea = null;
...
//					mMeteringArea.get(0).rect);
		calculateTapArea(focusWidth, focusHeight, 1f, x, y, ApplicationScreen.getPreviewTextureView().getWidth(), ApplicationScreen
				.getPreviewTextureView().getHeight(), mFocusArea.get(0).rect);
		if (ApplicationScreen.getMeteringMode() != -1 && ApplicationScreen.getMeteringMode() == CameraParameters.meteringModeSpot)
			calculateTapArea(20 + (CameraController.isNexus6 ? focusWidth : 0), 20 + (CameraController.isNexus6 ? focusHeight : 0), 1f, x, y, ApplicationScreen
							.getPreviewTextureView().getWidth(), ApplicationScreen.getPreviewTextureView().getHeight(),
					mMeteringArea.get(0).rect);
		else
			mMeteringArea = null;
