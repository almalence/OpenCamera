...
public final class AlmaShotSeamless
{
     ...
     * @param frame array of JPEG frame buffers
     * @param frame_len array of length of JPEG frame buffers 
     * @param nFrames number of frames
     * @param sx width of input frame
     * @param sy height of input frame
     * @return status string such as "frames total: "
     */
    public static synchronized native int ConvertAndDetectFacesFromJpegs
    (
    	int[] frame,
    	int[] frame_len,
    	int nFrames,
     ...
     * @param sx width of input frame
     * @param sy height of input frame
     * @param baseFrame to set as background image
     * @param numOfImg number of JPEG frames used for Seamless
     ...
     * @param baseFrame to set as background image
     * @param inWidth input frame width size
     * @param inHeight input frame Height size
     * @param outWidth output frame width size
     * @param outHeight output frame Height size
     * @param layout filled with index of frame.
     * @return ARGB888 pixel data
     */
    public static synchronized native int[] Preview(int baseFrame, int inWidth, int inHeight, int outWidth, int outHeight, byte[] layout);
    
    /**
     * Get NV21(YVU420 planer) as Seamless-processed result
     * @param baseFrame to set as background image
     * @param width input frame width size
     * @param height input frame Height size
     * @param crop array of 4 integer that contains x, y, width, height for cropping
     * @param layout filled with index of frame.
