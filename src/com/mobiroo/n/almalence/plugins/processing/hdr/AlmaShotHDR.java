...
public final class AlmaShotHDR
{
    ...
    public static synchronized native String HDRPreview2a(int sx, int sy, int[] pview, boolean rotate, int exposure, int vividness, int contrast, int microcontrast, boolean mirrored);
