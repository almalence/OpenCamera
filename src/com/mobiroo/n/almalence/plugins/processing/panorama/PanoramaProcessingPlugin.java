...
package com.mobiroo.n.almalence.plugins.processing.panorama;
...
import com.mobiroo.n.almalence.YuvImage;
...
public class PanoramaProcessingPlugin extends PluginProcessing
{
	...
	{
		super("com.mobiroo.n.almalence.plugins.panoramaprocessing",
	...
	private void saveFrames(final int[] images, final int offset, final int count, final int input_width, final int input_height)
	{
        ...
        {			
            ...
            final YuvImage out = new com.mobiroo.n.almalence.YuvImage(
