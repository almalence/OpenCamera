...
/* <!-- +++
package com.mobiroo.n.almalence.opencam_plus;
+++ --> */
// <!-- -+-
package com.mobiroo.n.almalence.opencam;
//-+- -->
...
import com.mobiroo.n.almalence.asynctaskmanager.Task;
import com.mobiroo.n.almalence.util.exifreader.imaging.jpeg.JpegMetadataReader;
import com.mobiroo.n.almalence.util.exifreader.imaging.jpeg.JpegProcessingException;
import com.mobiroo.n.almalence.util.exifreader.metadata.Directory;
import com.mobiroo.n.almalence.util.exifreader.metadata.Metadata;
import com.mobiroo.n.almalence.util.exifreader.metadata.exif.ExifIFD0Directory;
import com.mobiroo.n.almalence.util.exifreader.metadata.exif.ExifSubIFDDirectory;
import com.mobiroo.n.almalence.plugins.capture.burst.BurstCapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.bestshot.BestShotCapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.expobracketing.ExpoBracketingCapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.groupshot.GroupShotCapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.night.NightCapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.objectremoval.ObjectRemovalCapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.panoramaaugmented.PanoramaAugmentedCapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.preshot.PreshotCapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.sequence.SequenceCapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.standard.CapturePlugin;
import com.mobiroo.n.almalence.plugins.capture.video.VideoCapturePlugin;
import com.mobiroo.n.almalence.plugins.export.standard.ExportPlugin;
import com.mobiroo.n.almalence.plugins.processing.groupshot.GroupShotProcessingPlugin;
import com.mobiroo.n.almalence.plugins.processing.hdr.HDRProcessingPlugin;
import com.mobiroo.n.almalence.plugins.processing.night.NightProcessingPlugin;
import com.mobiroo.n.almalence.plugins.processing.objectremoval.ObjectRemovalProcessingPlugin;
import com.mobiroo.n.almalence.plugins.processing.panorama.PanoramaProcessingPlugin;
import com.mobiroo.n.almalence.plugins.processing.preshot.PreshotProcessingPlugin;
import com.mobiroo.n.almalence.plugins.processing.sequence.SequenceProcessingPlugin;
import com.mobiroo.n.almalence.plugins.processing.simple.SimpleProcessingPlugin;
import com.mobiroo.n.almalence.plugins.processing.bestshot.BestshotProcessingPlugin;
import com.mobiroo.n.almalence.plugins.vf.aeawlock.AeAwLockVFPlugin;
import com.mobiroo.n.almalence.plugins.vf.barcodescanner.BarcodeScannerVFPlugin;
import com.mobiroo.n.almalence.plugins.vf.focus.FocusVFPlugin;
import com.mobiroo.n.almalence.plugins.vf.grid.GridVFPlugin;
import com.mobiroo.n.almalence.plugins.vf.histogram.HistogramVFPlugin;
import com.mobiroo.n.almalence.plugins.vf.infoset.InfosetVFPlugin;
import com.mobiroo.n.almalence.plugins.vf.zoom.ZoomVFPlugin;
...
//			Log.e("NIGHT CAMERA DEBUG", "New created session = " + SessionID);
	...
	public boolean addToSharedMem_ExifTagsFromJPEGForExpoBracketing(final byte[] paramArrayOfByte, int num, final long SessionID) {		
		try
    	{
			...
			if(s1 != null) PluginManager.getInstance().addToSharedMem("exiftag_exposure_time"+String.valueOf(num)+String.valueOf(SessionID), s1);
			if(s2 != null) PluginManager.getInstance().addToSharedMem("exiftag_aperture"+String.valueOf(SessionID), s2);
			if(s3 != null) PluginManager.getInstance().addToSharedMem("exiftag_flash"+String.valueOf(SessionID), s3);
			if(s4 != null) PluginManager.getInstance().addToSharedMem("exiftag_focal_lenght"+String.valueOf(SessionID), s4);
			if(s5 != null) PluginManager.getInstance().addToSharedMem("exiftag_iso"+String.valueOf(SessionID), s5);
