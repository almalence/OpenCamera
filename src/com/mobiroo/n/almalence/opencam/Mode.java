...
For example:
- RGB and Luminance gistogram and center cross VF plugin
- expo-bracketing capture plugin
- HDR processing plugin
- simple filters plugin
- png/jpeg/gif export plugins

i.e. modes describes which plugins are active currently.

We can configure as many modes as needed.

Modes are configured with configuration file mode.xml located in assets directory

Mode.java class shouldn't be changed by user - modes will be filled on startup and stored in list in PluginManager
***/
...
public class Mode
{
	...
	public List<String> VF;		//list of VF plugins available in this mode
	...
	public String howtoText;	//text string describing how to use mode
