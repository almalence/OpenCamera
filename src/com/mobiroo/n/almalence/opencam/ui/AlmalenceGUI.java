...
/* <!-- +++
package com.mobiroo.n.almalence.opencam_plus.ui;
+++ --> */
// <!-- -+-
package com.mobiroo.n.almalence.opencam.ui;
//-+- -->
...
import com.mobiroo.n.almalence.ui.Panel;
import com.mobiroo.n.almalence.ui.RotateImageView;
import com.mobiroo.n.almalence.ui.Panel.OnPanelListener;

import com.mobiroo.n.almalence.googsharing.Thumbnail;

//<!-- -+-
import com.mobiroo.n.almalence.opencam.ConfigParser;
import com.mobiroo.n.almalence.opencam.MainScreen;
import com.mobiroo.n.almalence.opencam.Mode;
import com.mobiroo.n.almalence.opencam.Plugin;
import com.mobiroo.n.almalence.opencam.PluginManager;
import com.mobiroo.n.almalence.opencam.PluginType;
import com.mobiroo.n.almalence.opencam.Preferences;
import com.mobiroo.n.almalence.opencam.R;

//-+- -->
/* <!-- +++
import com.mobiroo.n.almalence.opencam_plus.ConfigParser;
import com.mobiroo.n.almalence.opencam_plus.MainScreen;
import com.mobiroo.n.almalence.opencam_plus.Mode;
import com.mobiroo.n.almalence.opencam_plus.Plugin;
import com.mobiroo.n.almalence.opencam_plus.PluginManager;
import com.mobiroo.n.almalence.opencam_plus.PluginType;
import com.mobiroo.n.almalence.opencam_plus.Preferences;
import com.mobiroo.n.almalence.opencam_plus.R;
+++ --> */
...
//				}
	...
	private boolean isCameraParameterSupported(String param) {
		if (param != "" && topMenuPluginButtons.containsKey(param))
			return true;
		else if (param != "" && com.mobiroo.n.almalence.util.Util.isNumeric(param))
		{
...
//		}
	...
	private void setInfo(boolean toLeft, float XtoVisible, float XtoInvisible,
		...
		duration_invisible = isAnimate ? com.mobiroo.n.almalence.util.Util
				.clamp(Math.abs(Math.round(((toLeft ? XtoVisible
						: (screenWidth - XtoVisible)) * 500) / screenWidth)),
						10, 500) : 0;
		
		int duration_visible = 0; 
		duration_visible = isAnimate ? com.mobiroo.n.almalence.util.Util
