...
package com.mobiroo.n.almalence.util;
...
public class AppWidgetNotifier
{
	...
	public static final boolean isABCWidgetInstalled(Activity activity)
    {
        try
        {
        	//activity.getPackageManager().getInstallerPackageName("com.mobiroo.n.almalence.pixfix");
        	activity.getPackageManager().getInstallerPackageName("com.mobiroo.n.almalence.opencamwidget");
        }
