...
public class SequenceCapturePlugin extends PluginCapture
{
	...
	{
		super("com.almalence.plugins.sequencecapture", R.xml.preferences_capture_sequence, 0, 0, null);
	}
	...
	{
		MainScreen.getGUIManager().showHelp(MainScreen.getInstance().getString(R.string.Sequence_Help_Header),
				MainScreen.getInstance().getResources().getString(R.string.Sequence_Help),
				R.drawable.plugin_help_sequence, "sequenceRemovalShowHelp");
	}
