...
//		}
	...
	private boolean isABCEditorInstalled()
	{
		try
		{
			MainScreen.getInstance().getPackageManager().getInstallerPackageName("com.almalence.opencameditor");
