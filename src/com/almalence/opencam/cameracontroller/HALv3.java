...
public class HALv3
{
	...
	public static void setCameraISOModeHALv3(int mode)
	{
		...
		{
			if (mode != 1)
				HALv3.previewRequestBuilder.set(CaptureRequest.SENSOR_SENSITIVITY, CameraController.getIsoModeHALv3()
						.get(mode));
			try
			{
				CameraController.iCaptureID = HALv3.getInstance().mCaptureSession.setRepeatingRequest(
	...
	private static int captureNextImageWithParams(final int format, final int pause, final int evRequested,
